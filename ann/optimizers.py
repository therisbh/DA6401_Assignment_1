...
class Momentum:
    # SGD with momentum - keeps a running velocity to smooth updates

    def __init__(self, lr, beta=0.9, weight_decay=0.0):
        self.lr = lr
        self.beta = beta
        self.weight_decay = weight_decay
        self.v_W = None   # velocity initialized on first call
        self.v_b = None
...
class RMSProp:
    # adapts learning rate per parameter using running avg of squared gradients
    ...
    def __init__(self, lr, beta=0.9, eps=1e-8, weight_decay=0.0):
        ...
        self.eps = eps
        self.weight_decay = weight_decay
        self.sq_W = None   # running avg of squared gradients
        self.sq_b = None
